...
square_1_play_note:
    ...
    ;Get the address.
    lda #>[@return_from_arpeggio_callback_sq1-1]
    pha
    lda #<[@return_from_arpeggio_callback_sq1-1]
    pha
    ...
    pha
    rts
@return_from_arpeggio_callback_sq1:
...
square_2_play_note:
    ...
    ;Get the address.
    lda #>[@return_from_arpeggio_callback_sq2-1]
    pha
    lda #<[@return_from_arpeggio_callback_sq2-1]
    pha
    lda arpeggio_callback_table_hi,y
    ...
    pha
    rts
@return_from_arpeggio_callback_sq2:
...
triangle_play_note:
    ...
    ;Get the address.
    lda #>[@return_from_arpeggio_callback_tri-1]
    pha
    lda #<[@return_from_arpeggio_callback_tri-1]
    pha
    lda arpeggio_callback_table_hi,y
    ...
    pha
    rts
@return_from_arpeggio_callback_tri:
...
noise_play_note:
    ...
    ;Get the address.
    lda #>[@return_from_arpeggio_callback_noise-1]
    pha
    lda #<[@return_from_arpeggio_callback_noise-1]
    pha
    lda arpeggio_callback_table_hi,y
    ...
    pha
    rts
@return_from_arpeggio_callback_noise:
...
;starting_read_address = sound_param_word_0
    ...
    STA stream
    LDA #<sound_param_word_0
    STA starting_read_address
    LDA #>sound_param_word_0
    STA starting_read_address+1
